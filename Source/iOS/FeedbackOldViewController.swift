...
private extension Selector {
    static let addPressed = #selector(FeedbackOldViewController.addPressed)
    static let refreshConversations = #selector(FeedbackOldViewController.refresh)
    static let presentNotice = #selector(FeedbackOldViewController.presentNotice)
}
...
@available(iOS 13.0, *)
public class FeedbackOldViewController: FetchedTableViewController<Conversation, ConversationCell>, FeedbackInjector, Dependencies {
